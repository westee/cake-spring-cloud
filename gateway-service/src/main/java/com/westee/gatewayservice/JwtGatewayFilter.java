...
public class JwtGatewayFilter implements GlobalFilter, Ordered {
    ...
    @Override
    public int getOrder() { return -1; } // 确保过滤器在所有路由处理之前执行。你可以根据需要调整顺序。返回负数将使过滤器在所有路由处理之前执行。返回正数将使过滤器在所有路由处理之后执行
}
