package com.westee.authservice.config;

import com.westee.authservice.realm.AuthorizationRealm;
import com.westee.authservice.realm.JWTAuthFilter;
import com.westee.authservice.realm.JWTCredentialsMatcher;
import com.westee.authservice.realm.JWTRealm;
import com.westee.authservice.realm.LoginType;
import com.westee.authservice.realm.MyModularRealmAuthenticator;
import com.westee.authservice.realm.UserPasswordRealm;
import com.westee.authservice.realm.WechatLoginRealm;
...
//    }
    ...
    @Bean
    public DefaultWebSecurityManager mySecurityManager(RedisCacheManager cacheManager) {
