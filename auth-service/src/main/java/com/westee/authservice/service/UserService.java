...
import com.westee.authservice.config.WxPayConfig;
import com.westee.authservice.entity.PageResponse;
import com.westee.authservice.entity.UsernameAndPassword;
import com.westee.authservice.entity.WeChatSession;
...
import com.westee.authservice.generate.UserExample;
import com.westee.authservice.generate.UserMapper;
...
import com.westee.authservice.realm.JWTUtil;
import com.westee.authservice.realm.LoginType;
import com.westee.authservice.util.Utils;
...
public class UserService {
    ...
    public User createUserIfNotExist(UsernameAndPassword usernameAndPassword) {
        User user = new User();
        ...
        try {
            ...
            throw HttpException.badRequest("用户已存在");
        }
        insertUserRole(user.getId(), 2L);
        return user;
    }
